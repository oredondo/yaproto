...
public class FSMEstadoOSPFv2VecinoDown extends FSMEstadoOSPFv2Vecino {
	static {
		_instancia = new FSMEstadoOSPFv2VecinoDown(FSMIdEstadoOSPFv2Vecino.DOWN);
	}

	protected FSMEstadoOSPFv2VecinoDown(FSMIdEstado id) {		
		super(id);
	}
	...
	public FSMEstado procesarEventoStart(
		...
		/** Acciones */		
		//Enviar Hello al vecino 
		FSMIdAccionOSPFv2Vecino.ENVIAR_HELLO_A_VECINO.getInstance().execute(contexto, evento.getArgumento());
