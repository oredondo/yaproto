...
public class pruebasDate {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//mensajeHello2=null;
		/*
		if(mensajeHello==null && mensajeHello2==null){
			System.out.println("0");
		}else if(mensajeHello==null){
			System.out.println("2");
		}else if(mensajeHello2==null){
		...
		*/
		...
		InetAddress allSPFRouters;
		try {
			allSPFRouters = InetAddress.getByName("224.0.0.5");
		

		
		Escritura escritura = new Escritura(mensajeHello);
		escritura.setDireccionDestino(new InetSocketAddress(allSPFRouters, 0)); //direccion AllSPFRouters
		
		InetAddress dirDestino = ((InetSocketAddress) escritura.getDireccionDestino()).getAddress();
		if(dirDestino.equals(allSPFRouters)){
