...
public class FSMEstadoOSPFv2InterfazDrother extends FSMEstadoOSPFv2Interfaz {
	static {
		_instancia = new FSMEstadoOSPFv2InterfazDrother(FSMIdEstadoOSPFv2Interfaz.DROTHER);
	}

	protected FSMEstadoOSPFv2InterfazDrother(FSMIdEstado id) {		
		super(id);
	}
	...
	public FSMEstado procesarEventoNeighborChange(
		...
		System.out.println("FSMEstadoOSPFv2InterfazDrother:eventoNeighborChange(): guarda= " + guarda);
