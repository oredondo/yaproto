...
public class FSMEstadoOSPFv2InterfazLoopback extends FSMEstadoOSPFv2Interfaz {
	static {
		_instancia = new FSMEstadoOSPFv2InterfazLoopback(FSMIdEstadoOSPFv2Interfaz.LOOPBACK);
	}

	protected FSMEstadoOSPFv2InterfazLoopback(FSMIdEstado id) {		
		super(id);
	}
