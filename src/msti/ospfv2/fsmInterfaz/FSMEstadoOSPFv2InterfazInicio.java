 ...
 */
public class FSMEstadoOSPFv2InterfazInicio extends FSMEstadoInicio {
	static {
		_instancia = new FSMEstadoOSPFv2InterfazInicio(FSMIdEstadoOSPFv2Interfaz.INICIO);
	}

	protected FSMEstadoOSPFv2InterfazInicio(FSMIdEstado id) {		
		super(id);
	}
