...
public class FSMEstadoOSPFv2InterfazWaiting extends FSMEstadoOSPFv2Interfaz {
	static {
		_instancia = new FSMEstadoOSPFv2InterfazWaiting(FSMIdEstadoOSPFv2Interfaz.WAITING);
	}

	protected FSMEstadoOSPFv2InterfazWaiting(FSMIdEstado id) {		
		super(id);
	}
	...
	public FSMEstado procesarEventoWaitTimer(
		...
		System.out.println("FSMEstadoOSPFv2InterfazWaiting:eventoWaitTimer(): guarda= " + guarda);
	...
	public FSMEstado procesarEventoBackupSeen(
		...
		System.out.println("FSMEstadoOSPFv2InterfazWaiting:eventoBackupSeen(): guarda= " + guarda);
