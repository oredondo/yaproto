...
public class MensajeNetlinkRouteAttributeIif extends MensajeNetlinkRouteAttribute implements IMensaje, IMensajeNetlinkRouteAttributeIif {
	...
	protected MensajeNetlinkRouteAttributeIif() {
		super();		
	}
	 ...
	 */
	public static class Builder extends MensajeNetlinkRouteAttribute.Builder implements IMensajeBuilder, IMensajeNetlinkRouteAttributeIif, IMensajeNetlinkRouteAttributeIif.Build {
		
		private Builder() {
			_builder = this;
			mensaje = new MensajeNetlinkRouteAttributeIif(); //inicializa el mensaje heredado con el tipo adecuado
		}

		/* Sobreescribe para cambiar el tipo devuelto y usarlo tipado donde se requiera */
		@Override
		protected MensajeNetlinkRouteAttributeIif getMensaje() {
			return (MensajeNetlinkRouteAttributeIif)this.mensaje;
		}
		...
		@Override
		public MensajeNetlinkRouteAttributeIif build() {
		...
		public static MensajeNetlinkRouteAttributeIif getDefaultInstanceforType() {
			// TODO: Petición de tabla de rutas puede ser el mensaje por defecto
			MensajeNetlinkRouteAttributeIif mensaje = new MensajeNetlinkRouteAttributeIif();
			mensaje.estaConstruido = true;
			return mensaje;
		}
		...
		public Builder mezclarDesde(IMensaje mensajeOrigen) {
			...
			if (mensaje instanceof IMensajeNetlinkRouteAttribute) {
				...
				MensajeNetlinkRouteAttributeIif _mensajeOrigen = (MensajeNetlinkRouteAttributeIif)mensajeOrigen;
		...
		/* IMensajeNetlinkRouteAttributeIif */
	...
	public String toString() {
		...
		sb.append(" MensajeNetlinkRouteAttributeIif");
