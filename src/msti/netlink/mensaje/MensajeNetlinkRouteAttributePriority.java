...
public class MensajeNetlinkRouteAttributePriority extends MensajeNetlinkRouteAttribute implements IMensaje, IMensajeNetlinkRouteAttributePriority {
	...
	protected MensajeNetlinkRouteAttributePriority() {
		super();		
	}
	 ...
	 */
	public static class Builder extends MensajeNetlinkRouteAttribute.Builder implements IMensajeBuilder, IMensajeNetlinkRouteAttributePriority, IMensajeNetlinkRouteAttributePriority.Build {
		
		private Builder() {
			_builder = this;
			mensaje = new MensajeNetlinkRouteAttributePriority(); //inicializa el mensaje heredado con el tipo adecuado
		}

		/* Sobreescribe para cambiar el tipo devuelto y usarlo tipado donde se requiera */
		@Override
		protected MensajeNetlinkRouteAttributePriority getMensaje() {
			return (MensajeNetlinkRouteAttributePriority)this.mensaje;
		}
		...
		@Override
		public MensajeNetlinkRouteAttributePriority build() {
		...
		public static MensajeNetlinkRouteAttributePriority getDefaultInstanceforType() {
			// TODO: Petición de tabla de rutas puede ser el mensaje por defecto
			MensajeNetlinkRouteAttributePriority mensaje = new MensajeNetlinkRouteAttributePriority();
			mensaje.estaConstruido = true;
			return mensaje;
		}
		...
		public Builder mezclarDesde(InputStream inputStream) throws IOException {
			...
			/* priority */
			this.setPriority((getMensaje().isNetByteOrder ? dis.readInt() : reverseIfNeeded(dis.readInt())));
			leidos += 4;
		...
		public Builder mezclarDesde(IMensaje mensajeOrigen) {
			...
			if (mensaje instanceof IMensajeNetlinkRouteAttribute) {
			...
			else if (mensaje instanceof IMensajeNetlinkRouteAttributePriority) {
				...
				MensajeNetlinkRouteAttributePriority _mensajeOrigen = (MensajeNetlinkRouteAttributePriority)mensajeOrigen;
				if (_mensajeOrigen.hasPriority())
					this.setPriority(_mensajeOrigen.getPriority());
			}
			else 
		...
		public boolean estaCompleto() {
			return (super.estaCompleto() &&
					getMensaje().hasPriority());			
		}

		/* IMensajeNetlinkRouteAttributePriority */

		@Override
		public Builder setPriority(int priority) {
			getMensaje().priority = priority;
			getMensaje().hasPriority = true;			
			return this;
		}

		@Override
		public int getPriority() {
			return getMensaje().priority;
		}

		@Override
		public boolean hasPriority() {
			return getMensaje().hasPriority;
		}
	...
	public String toString() {
		...
		sb.append(" MensajeNetlinkRouteAttributePriority");
		...
		sb.append("\n Datos:");
		sb.append("  priority="); 			sb.append(this.getPriority());
