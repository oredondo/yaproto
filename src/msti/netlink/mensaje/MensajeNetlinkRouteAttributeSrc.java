...
public class MensajeNetlinkRouteAttributeSrc extends MensajeNetlinkRouteAttribute implements IMensaje, IMensajeNetlinkRouteAttributeSrc {
	...
	protected MensajeNetlinkRouteAttributeSrc() {
		super();		
	}
	 ...
	 */
	public static class Builder extends MensajeNetlinkRouteAttribute.Builder implements IMensajeBuilder, IMensajeNetlinkRouteAttributeSrc, IMensajeNetlinkRouteAttributeSrc.Build {
		
		private Builder() {
			_builder = this;
			mensaje = new MensajeNetlinkRouteAttributeSrc(); //inicializa el mensaje heredado con el tipo adecuado
		}

		/* Sobreescribe para cambiar el tipo devuelto y usarlo tipado donde se requiera */
		@Override
		protected MensajeNetlinkRouteAttributeSrc getMensaje() {
			return (MensajeNetlinkRouteAttributeSrc)this.mensaje;
		}
		...
		@Override
		public MensajeNetlinkRouteAttributeSrc build() {
		...
		public static MensajeNetlinkRouteAttributeSrc getDefaultInstanceforType() {
			// TODO: Petici�n de tabla de rutas puede ser el mensaje por defecto
			MensajeNetlinkRouteAttributeSrc mensaje = new MensajeNetlinkRouteAttributeSrc();
			mensaje.estaConstruido = true;
			return mensaje;
		}
		...
		public Builder mezclarDesde(IMensaje mensajeOrigen) {
			...
			if (mensaje instanceof IMensajeNetlinkRouteAttribute) {
			...
			else if (mensaje instanceof IMensajeNetlinkRouteAttributeSrc) {
				...
				MensajeNetlinkRouteAttributeSrc _mensajeOrigen = (MensajeNetlinkRouteAttributeSrc)mensajeOrigen;
		...
		/* IMensajeNetlinkRouteAttributePrefsrc */
	...
	public String toString() {
		...
		sb.append(" MensajeNetlinkRouteAttributePrefsrc");
