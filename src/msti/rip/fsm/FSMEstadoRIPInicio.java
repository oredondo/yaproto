 ...
 */
public class FSMEstadoRIPInicio extends FSMEstadoInicio {
	static {
		_instancia = new FSMEstadoRIPInicio(FSMIdEstadoRIP.INICIO);
	}

	protected FSMEstadoRIPInicio(FSMIdEstado id) {		
		super(id);
	}
	...
	public FSMEstado procesarEventoInicio (FSMContexto contexto) {
		...
		FSMIdAccionRIP.REINICIAR_TEMPORIZADOR_DIFUSIONPERIODICA.getInstance().execute(contexto, null);
